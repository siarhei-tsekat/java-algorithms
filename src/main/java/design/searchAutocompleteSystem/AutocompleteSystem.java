package design.searchAutocompleteSystem;
...
public class AutocompleteSystem {
    ...
    public List<String> input(char c) {
        ...
        if (c == '#') {
            ...
            AutocompleteSystem.lastNode = null;
            word = new StringBuilder();
            return Collections.emptyList();
        } else if(word.length() > 1 && lastNode!= null){
            word.append(c);
            res = trie.search(word.toString(), lastNode);
        } else {
            word.append(c);
...
class Trie {
    ...
    public List<Sentence> search(String str) {
        ...
        for (int i = 0; i < chars.length; i++) {
            ...
            node = node.get(chars[i]);
            AutocompleteSystem.lastNode = node;
        }
    ...
    public List<Sentence> search(String str, TrieNode lastNode) {
